...
tinsert(ZGV.startups,function(self)
	...
	if QuestFrameDetailPanel and QuestFrameDetailPanel.HookScript then QuestFrameDetailPanel:HookScript("OnShow",QuestFrameDetailPanel_fixAutoQuest) end
end)
...
function me:QUEST_DETAIL()
	...
	if self.db.profile.autoaccept then
		...
		for i,goal in ipairs(self.CurrentStep.goals) do
			if goal.action=="accept" and goal.quest==title and goal:IsCompleteable() and goal:GetStatus()~="obsolete" then
