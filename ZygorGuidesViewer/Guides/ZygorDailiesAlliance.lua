...
local function ZygorClassic_LoadAllianceDailies190()
...
if ZygorGuidesViewer.AllianceDailiesInstalled then return true end
...
ZygorClassic_DeferredGuideLoad190(ZygorClassic_LoadAllianceDailies190,"AllianceDailies")
