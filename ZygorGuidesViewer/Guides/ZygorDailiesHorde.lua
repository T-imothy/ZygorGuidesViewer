...
local function ZygorClassic_LoadHordeDailies190()
...
if ZygorGuidesViewer.HordeDailiesInstalled then return true end
...
ZygorClassic_DeferredGuideLoad190(ZygorClassic_LoadHordeDailies190,"HordeDailies")
