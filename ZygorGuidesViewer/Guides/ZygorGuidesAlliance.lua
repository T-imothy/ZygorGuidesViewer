...
local function ZygorClassic_LoadAllianceLeveling190()
local faction=(ZygorClassic_Faction262 and ZygorClassic_Faction262()) or UnitFactionGroup("player")
if not faction then return false end
if faction~="Alliance" then return true end
if ZygorGuidesViewer.AllianceInstalled then return true end
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Leveling Guides\\Human (1-13)",[[
	...
	step //138
		goto Stormwind City,69,30.9|n
		'Enter the Deeprun Tram station
	step //139
		'Ride the Deeprun Tram to Ironforge|goto Ironforge|noway|c
step //140
		'Leave Ironforge and follow the eastern road through Dun Morogh|goto Dun Morogh,68.7,56,1|noway|c
step //141
		'Continue east past Gol'Bolar Quarry|goto Dun Morogh,78.1,50.4,1|noway|c
step //142
		'Follow the road to the South Gate Pass|goto Dun Morogh,87.4,51.1,1|noway|c
step //143
		'Travel east through Dun Morogh into Loch Modan|goto Loch Modan|noway|c
	step //144
		'Follow the road north from the South Gate Pass|goto Loch Modan,22.4,68.2,1|noway|c
	step //145
		'Keep north on the main road past Thelsamar|goto Loch Modan,25.6,45.4,1|noway|c
	step //146
		'Continue north toward Dun Algaz|goto Loch Modan,24.8,22.1,1|noway|c
	step //147
		'Follow the northern road into Dun Algaz|goto Loch Modan,25.4,10.4,1|noway|c
	step //148
		'Go through the first Dun Algaz tunnels|goto Wetlands,49.7,79.5|noway|c
	step //149
		'Finish crossing Dun Algaz into the Wetlands|goto Wetlands,53.9,70.3,1|noway|c
	step //150
		'Follow the road northwest toward the Greenwarden|goto Wetlands,49.9,57.2,1|noway|c
	step //151
		'Continue west through the Wetlands|goto Wetlands,33.5,49.6,1|noway|c
	step //152
		'Follow the western road toward Menethil Harbor|goto Wetlands,18.5,51.2,1|noway|c
	step //153
		goto Wetlands,9.5,59.7
		.talk Shellei Brondir##1571
		..fpath Menethil Harbor
	step //154
		goto Wetlands,4.6,57.2|n
		'Travel to the Auberdine boat dock at Menethil Harbor
	step //155
		'Ride the boat from Menethil Harbor to Auberdine|goto Darkshore,32.4,43.7,1|noway|c
	step //156
	...
	step //170
		...
		'Ride the boat back to Menethil Harbor|goto Wetlands,4.6,56.8,9|noway|c
	step //171
		'Fly from Menethil Harbor to Ironforge|goto Ironforge|noway|c
	step //172
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Leveling Guides\\Night Elf (1-13)",[[
	...
	step //74
		'Enter Ban'ethil Barrow Den and stay on the upper level|goto Teldrassil,44.4,57.8,0.5|c
	step //75
		goto 43.7,61.2
		.' Cross the upper-right bridge and enter the small room
		.' Click the Chest of the Black Feather|tip It is on the ground along the right wall of the small room.
		.get Black Feather Quill|q 483/2
	step //76
		goto 44.4,60.7
		.' Return to the upper hub and cross the middle bridge
		.' Click the Chest of Nesting|tip It is on the ground to the right inside the small room.
		.get Rune of Nesting|q 483/4
	step //77
		'Descend beneath the Black Feather room, cross the large bridge, then take the small room on the right|goto 44.9,61.6
		.talk Oben Rageclaw##7317
		..accept The Sleeping Druid##2541
	step //78
		'Leave Oben's room and take the opposite tunnel|goto 45.6,58.7
		.from Gnarlpine Shaman##2009+
		.get Shaman Voodoo Charm|q 2541/1
	step //79
		'In Rageclaw's circular room, go up the ramp on the left and cross the bridge on the right|goto 45.7,57.4
		.' Click the Chest of the Raven Claw|tip The chest is on the ledge across the bridge.
		.get Raven Claw Talisman|q 483/1
	step //80
		'Backtrack through the tunnel to Oben's room|goto 44.9,61.6
		.talk Oben Rageclaw##7317
		..turnin The Sleeping Druid##2541
		..accept Druid of the Claw##2561
	step //81
		'Take the opposite tunnel back to Rageclaw's circular room|goto 45.6,58.7
		.kill Rageclaw##7318|n
		.' Use the Voodoo Charm on his corpse before it disappears|use Voodoo Charm##8149
		.' Release Oben Rageclaw's spirit|goal Release Oben Rageclaw's spirit|q 2561/1
	step //82
		'Return through the tunnel toward Oben, then take the lower path near Greenpaw|goto 44.7,62.5
		.' Click the Chest of the Sky|tip It is at the bottom of the lower path near Greenpaw.
		.get Sapphire of Sky|q 483/3
	step //83
		'Go back up the lower path to Oben's room|goto 44.9,61.6
		.talk Oben Rageclaw##7317
...
ZygorClassic_DeferredGuideLoad190(ZygorClassic_LoadAllianceLeveling190,"AllianceLeveling")
