...
local function ZygorClassic_LoadHordeLeveling190()
local faction=(ZygorClassic_Faction262 and ZygorClassic_Faction262()) or UnitFactionGroup("player")
if not faction then return false end
if faction~="Horde" then return true end
if ZygorGuidesViewer.HordeInstalled then return true end
...
ZygorClassic_DeferredGuideLoad190(ZygorClassic_LoadHordeLeveling190,"HordeLeveling")
