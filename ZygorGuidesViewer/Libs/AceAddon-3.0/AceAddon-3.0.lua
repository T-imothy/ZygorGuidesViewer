...
function AceAddon:EmbedLibraries(addon, ...)
	for i=1,select("#", unpack(arg) ) do
		local libname = select(i, unpack(arg))
...
local function onEvent(this, event, arg1)
	if event == "ADDON_LOADED" or event == "PLAYER_LOGIN" then
		...
		while(ZGV_len(AceAddon.initializequeue) > 0) do
		...
		if IsLoggedIn() then
			while(ZGV_len(AceAddon.enablequeue) > 0) do
...
AceAddon.frame:SetScript("OnEvent", function() onEvent(this,event,arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9) end)
